...
class EncaminhamentoControllerTest {
    ...
    @Test
    void getEncaminhamento_usaTpLeitoExplicitoQuandoInformado() {
        EncaminhamentoService service = mock(EncaminhamentoService.class);
        EncaminhamentoController controller = new EncaminhamentoController(service);
    ...
    @Test
    void getEncaminhamento_resolveTpLeitoQuandoNaoInformado() {
        EncaminhamentoService service = mock(EncaminhamentoService.class);
        EncaminhamentoController controller = new EncaminhamentoController(service);
        ...
        EncaminhamentoResponse result =
                controller.getEncaminhamento("3131307", "dengue", "moderada", null, 1);
